...
if classification is True:
    ...
    model_name = "{}_{}_{}_{}_{}".format('VGG16', 'Classification', 'Crop', 'Grayscale', 'Resize')
else:
...
f = open('./val_score.csv', 'w')
f.write('epoch,step,val_acc,val_loss\n')
        ...
        for j in range(train_batches):
            ...
            if i != 0 and flag:
                ...
                if cur_val_acc < max_val_acc:
                    ...
                    saver.save(sess, './checkpoints/model{}/model.ckpt'.format(i))
                    print("\tSaved step {}, val_acc : {}, val_loss : {:.4f}".format(step, max_val_acc, cur_val_loss))
                    f.write('{},{},{},{}\n'.format(i, step, max_val_acc, cur_val_loss))
